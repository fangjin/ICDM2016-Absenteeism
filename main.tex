...
\begin{figure}[t]
	...
	\caption{(a) Brazil $5$ nearest-neighbor Graph: 5321 cities an all edge weights are $1$. (b) Brazil Z-score on July 31th, 2013, the color bar shows the scale of Z-score.}
